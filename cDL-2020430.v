...
(*DEL Notation "-' e" := (oppC e) (at level 52). *)
...
Definition CDLexp_2_Prop (e : cDL_exp) (st : Var -> Z) (fn : CName -> Z) (gn : CName -> Z) : Prop :=
...
Definition CDLexp_2_Arith (e : cDL_exp) (st : Var -> Z) (fn : CName -> Z) (gn : CName -> Z) : Prop :=
...
(* Rule (o) *)
  r_o : forall (T : Gamma) (pls1 : place) (pls2 : place) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName),
        (
          ...
          (
            forall (st : Var -> Z) (fn : CName -> Z) (gn : CName -> Z) , (CDLexp_2_Arith fof st fn gn)
...
Theorem tst9 : forall (st : Var -> Z) (fn gn : CName -> Z), 
(
...
Theorem tst8 : forall (st : Var -> Z) (fn gn : CName -> Z), 
(
(gn (clk 3) = 0 /\
     gn (clk 2) = 0 /\
     fn (clk 1) = st (var 3) + 1 /\
...
Definition inv2 : cDL_exp := h(v1) -' h(v3) >' 0 /\' h(v3) -' h(u1) >=' 0. 
...
Proof.
  ...
  - (*@*) apply r_extR. exists 4. simpl. split. (* rule ext r *)
    + intuition. + apply r_o. cbn. intros. omega. (* rule o *)
  - apply r_allR. apply r_impR; apply r_impR. cbn. (* rule all r, rule -> r *)
    ...
    apply r_Guard. apply r_andR; split. (* rule g?, /\ r *)
  ...
  - apply r_extR. exists 0. simpl. split. + intuition. + apply r_impR. (* rule ext r, -> r*)
    apply r_Seq. apply r_Choice. apply r_orR_2. apply r_Choice. apply r_orR_2. (* rule sequence, cho, \/ r 2, 
    cho, \/ r 2 *)
    apply r_Guard. apply r_andR; split.              (* rule g?, /\ r *)
    * (*@*) apply r_o. cbn. intros. omega. (* rule o *)
    * apply r_Alpha_c; apply r_Alpha_c; apply r_Alpha_idle2; apply r_Alpha_idle1. cbn. (* rule alpha *)
      apply r_andR; split. Focus 2. (* rule /\ r *)
      { (*@*) apply r_o. cbn. intros. omega.  } Unfocus. (* rule o *)
      { apply r_Omega_dia; exists inv2; split. (* rule << omega >> *)
        - (*@*) apply r_o. cbn. intros. omega. (* rule o *)
        - apply r_impR. apply r_Choice. apply r_orR_2. apply r_Choice. apply r_orR_2. (* rule -> r, 
      cho, \/ r 2, cho, \/ r 2 *)
          apply r_Alpha_c; apply r_Alpha_c; apply r_Alpha_c; apply r_Alpha_idle1; cbv. (* rule alpha *)
