...
(* guard g*)
Inductive g_exp := 
  gltC : h_f -> h_f -> nat -> g_exp |
  gleC : h_f -> h_f -> nat -> g_exp |
  ggtC : h_f -> h_f -> nat -> g_exp |
  ggeC : h_f -> h_f -> nat -> g_exp |
  geqC : h_f -> h_f -> nat -> g_exp
.
...
Fixpoint cdl_subsE (e : cDL_exp) (E : e_exp) (u : VarType) : cDL_exp := (* e[E // x] *)
    ...
    | cdlDiaC p phi psi => cdlDiaC p phi psi 
(*we assume that our sequent is single-targeted and there is only one dynamic formula, 
so we don't need to consider the substitution in the CPM*)
    | cdlFalseC => cdlFalseC
    ...
    | cdlBoxC p phi psi => cdlBoxC p phi psi
  end.
...
Fixpoint CDLexp_2_FOLF_Arith (e : cDL_exp) (st : state) (fn : state) (gn : state) : FOLF :=
  match e with
  | cdlTrueC => pureC (0 = 0)
  | cdlLEC e1 e2 => pureC ((Eexp_2_exp e1 st fn gn) <= (Eexp_2_exp e2 st fn gn))
...
Variable st0 : Var -> nat. 
Variable fn0 : CName -> nat.
Variable gn0 : CName -> nat.
...
Definition CDLexp_2_Arith (e : cDL_exp) (st : state) (fn : state) (gn : state) : Prop :=
...
are contained in the substituting expression*)
    ...
    | cdlDiaC p phi psi => True (*currently we can safely skip dynamic formula since we only consider single-targeted
      sequent in the derivation*)
    | cdlFalseC => True
    ...
    | cdlBoxC p phi psi => True (*currently we can safely skip dynamic formula since we only consider single-targeted
      sequent in the derivation*)
    end.
...
|
  r_placeL_rmv : forall (T : Gamma) (D : Delta) (pls2 : place) (V : list Var) (C : list CName) (ntC : list CName)
                        (phi : cDL_exp),
          (
...
|
  r_placeL_add : forall (T' : Gamma) (D : Delta) (pls2 : place) (V : list Var) (C : list CName) (ntC : list CName)
                        (phi : cDL_exp),
          (
...
|
  r_Alpha_idle1 : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName)
                    (phi : cDL_exp) (psi : cDL_exp), 
          (
            Seq T empty (exp (phi /\' psi)) D V C C (* when ntC = nil, reset it to C *) 
          )
          ->
          (
            Seq T empty (exp (<< @ idle >> (phi, psi))) D V C nil
          )
|
  r_Alpha_idle2 : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (c : CName) (ntC' : list CName)
          ...
          ->
          (
            Seq T empty (exp (<< @ idle >> (phi, psi))) D V C (c :: ntC')
          )
|

(* Rule epsilon *)
  r_Eps : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName)
                  (phi : cDL_exp) (psi : cDL_exp), 
          (
          ...
          ->
          (
            Seq T empty (exp (<< eps >> (phi, psi))) D V C ntC
          )
|

(* Rule g? *)
  r_Guard : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName)
                          (g : g_exp) (a : ClkEvt) (phi : cDL_exp) (psi : cDL_exp), 
          (
            Seq T empty (exp ((G_2_cdl g) /\' << a >> (phi, psi))) D V C ntC
          )
          ->
          (
            Seq T empty (exp (<< g ? a >> (phi, psi))) D V C ntC
          )
|

(* Rule halt *)
  r_Halt : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName)
                          (phi : cDL_exp) (psi : cDL_exp), 
          (
            Seq T empty (exp ff') D V C ntC
          )
          ->
          (
            Seq T empty (exp (<< halt >> (phi, psi))) D V C ntC
          )
|

(* Rule << omega >> *)
  r_Omega_dia : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName)
...
(* Rule choice *)
  r_Choice : forall (T: Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName)
          ...
          ->
          (
            Seq T empty (exp (<< p U q >> (phi, psi))) D V C ntC
          )
|

(* Rule sequence *)
  r_Seq : forall (T: Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName)
                      (p : CPM_exp) (q : CPM_exp) (phi : cDL_exp) (psi : cDL_exp),
          (
            Seq T empty
                    (
          ...
          ->
          (
            Seq T empty (exp (<< p;q >> (phi, psi))) D V C ntC
          )
|

(* Rule star n *)
  r_Star_n : forall (T: Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName)
                      (p : CPM_exp) (phi : cDL_exp) (psi : cDL_exp),
          (
            Seq T empty
                    (
          ...
          ->
          (
            Seq T empty (exp (<< p^* >> (phi, psi))) D V C ntC
          )
|
(* Rule << star >> *)
  r_Star_dia : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName)
                  (p : CPM_exp) (phi : cDL_exp) (psi : cDL_exp), 
          (
              ...
              (
                ...
                Seq nil empty 
                          (exp (
                            ...
                            nil
                              (cdl_V (all X, X >' 0 ->' ((inv X) ->' << p >> (inv (X -' 1), psi))) nil)
                                  C 
                                    ntC
                )
              )
...
(* ****************************** rules of FOL *********************** *)
(* Rule (o) *)
  r_o : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName),
        (
...
(* Rule (cut) *)
  r_cut : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName), 
        (
          forall (phi : cDL_exp),
            (
...
(* Rule (~ r) *)
  r_negR : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName)
                (phi : cDL_exp),
        (
...
(* Rule (~ l) *)
  r_negL : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName)
                (phi : cDL_exp),
        (
          Seq T empty (exp (~' phi)) D V C ntC
        )
...
(* Rule (/\ r) *)
  r_andR : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName)
...
(* Rule (/\ l 1) *)
  r_andL_1 : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName)
                (phi1 : cDL_exp) (phi2 : cDL_exp),
        (
          Seq (phi2 :: T) 
...
(* Rule (/\ l 2) *)
  r_andL_2 : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName)
                (phi1 : cDL_exp) (phi2 : cDL_exp),
        (
          Seq (phi2 :: T) 
                (exp phi2) empty D V C ntC
        )
        ->
        (
          Seq T (exp (phi1 /\' phi2)) empty D V C ntC
...
(* Rule (all r) *)
  r_allR : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName)
                (phi : cDL_exp) (x : Var),
        (
          let n := NewId V in
          (
...
(* Rule (all l) *)
  ...
  r_allL : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName)
                (phi : cDL_exp) (x : Var),
        (
          exists (E : e_exp),
          (
...
(* Rule (\/ r 1) *)
  r_orR_1 : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName) 
                 (phi1 : cDL_exp) (phi2 : cDL_exp),
        (
          Seq T empty (exp phi1) D V C ntC
        )
...
(* Rule (\/ r 2) *)
  r_orR_2 : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName) 
                 (phi1 : cDL_exp) (phi2 : cDL_exp),
        (
          Seq T empty (exp phi2) D V C ntC
        )
...
(* Rule (\/ l) *)
  r_orL : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName) 
                (phi1 : cDL_exp) (phi2 : cDL_exp),
        (
          (
...
(* Rule (-> r) *)
  r_impR : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName)
                  (phi1 : cDL_exp) (phi2 : cDL_exp),
        (
...
(* Rule (-> l) *)
  r_impL : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName)
                  (phi1 : cDL_exp) (phi2 : cDL_exp),
        (
          (
            Seq T empty (exp phi1) D V C ntC
...
(* Rule (ext r) *)
  r_extR : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName) 
                  (phi : cDL_exp) (x : Var),
        (
          exists (E : e_exp),
            (cdl_chk phi (e_exp_V E nil) (&x) nil) (* make sure that the substitution phi[E / x] is admissible *)
...
(* Rule (ext l) *)
  r_extL : forall (T : Gamma) (D : Delta) (V : list Var) (C : list CName) (ntC : list CName)
                (phi : cDL_exp) (x : Var),
        (
          let n := NewId V in
          (
